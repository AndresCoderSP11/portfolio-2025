    ...
    return (
        <>
            <motion.div
                ...
                initial="hidden"
                whileInView="show"
                className='grid grid-cols-2 gap-20 mb-10'>

                <div className='rounded-3xl border shine-container w-full h-92'>
                    <img className='rounded-2xl w-full' src="/proyectos/proyecto-uptask.png" alt="" />
                </div>
                ...
                <div>
                    ...
                    <div className=' flex gap-5  justify-end'>
                        <img className='' src="/proyectos/uptask-figma.png" alt="Foto dde GitHub" />
